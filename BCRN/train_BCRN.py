...
parser.add_argument("--start-epoch", default=605, type=int,
...
parser.add_argument("--pretrained", default="checkpoint_x2/epoch_604.pth", type=str,
...
model = BluePrintConvNeXt_SR(upscale_factor=args.scale)
