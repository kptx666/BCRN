...
parser.add_argument("--test_hr_folder", type=str, default='Test_Datasets/Set14/',
                    help='the folder of the target images')
parser.add_argument("--test_lr_folder", type=str, default='Test_Datasets/Set14_LR/x4/',
                    help='the folder of the input images')
parser.add_argument("--output_folder", type=str, default='results/Set14/x4')
parser.add_argument("--checkpoint", type=str, default='checkpoint_x4/epoch_1220.pth',
...
model = BluePrintConvNeXt_SR(upscale_factor=opt.upscale_factor)
